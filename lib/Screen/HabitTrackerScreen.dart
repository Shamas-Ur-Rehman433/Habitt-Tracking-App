...
import 'package:habit_tracker/Screen/NotificationsScreen.dart';
import 'package:habit_tracker/Screen/PersonalInfoScreen.dart';
import 'package:habit_tracker/Screen/ReportsScreen.dart';
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Dismissible(
                        ...
                        onDismissed: (direction) {
                          setState(() {
                            // Remove habit from completedHabitsMap when swiped
                            completedHabitsMap.remove(habit);
                            _saveHabits(); // Save updated state
                          });
                        },
                        background: Container(
