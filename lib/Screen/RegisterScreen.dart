...
import 'package:habit_tracker/Screen/CountryList.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _loadCountries() async {
    try {
      ...
      countries = countries.toSet().toList(); // Remove duplicates
      countries.sort(); // Sort alphabetically

      setState(() {
        _countries = countries;
        _country = countries.isNotEmpty ? countries.first : 'United States';  // Default to first country
      });
    } catch (e) {
      _showToast('Error fetching countries: ${e.toString()}');
      setState(() {
        _countries = [];
        _country = 'United States';  // Default fallback
      });
    }
  }
